...
export class Backend implements backendInterface {
    ...
    async createReservation(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateMenuItem(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: number, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateReservationStatus(arg0: bigint, arg1: string): Promise<[string, bigint]> {
        if (this.processError) {
            try {
